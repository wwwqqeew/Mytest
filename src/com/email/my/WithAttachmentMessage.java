...
public class WithAttachmentMessage {  
    ...
    public MimeMessage createMessage(Session session) throws Exception {  
        ...
        String from = "wwwqqeew@163.com";  
        String to = "337162169@qq.com";  
...
//        MimeBodyPart attachment01 = createAttachment("F:\\java\\Hello_JavaMail.java");  
        MimeBodyPart attachment02 = createAttachment("D:\\goods.sql");  
        MimeBodyPart content = createContent(body, "D:\\ken.png");  
...
//        allPart.addBodyPart(attachment01);  
     ...
     * @param to 
     */ 
    public MimeMessage createMessage(Session session, String from, String to, String tltle, String bodyHtml) throws Exception {  
 
//        String from = "wwwqqeew@163.com";  
//        String to = "337162169@qq.com";  
          
//        String subject = "创建内含附件、图文并茂的邮件！";  
//        String body2 = "<h4>内含附件、图文并茂的邮件测试！！！</h4> </br>" 
//                + "<a href = http://haolloyin.blog.51cto.com/> 蚂蚁</a></br>" 
//                + "<img src = \"cid:logo_jpg\"></a>";  
        ...
        msg.setFrom(new InternetAddress(from));  
        msg.setRecipient(Message.RecipientType.TO, new InternetAddress(to));  
        msg.setSubject(tltle);  
 
        // 创建邮件的各个 MimeBodyPart 部分  
//        MimeBodyPart attachment01 = createAttachment("F:\\java\\Hello_JavaMail.java");  
//        MimeBodyPart attachment02 = createAttachment("D:\\goods.sql");  
//        MimeBodyPart content = createContent(body2, "D:\\ken.png");  
        ...
        // 正文的文本部分  
        MimeBodyPart textBody = new MimeBodyPart();  
        textBody.setContent(bodyHtml, "text/html;charset=gbk");  
        contentMulti.addBodyPart(textBody);  
        // 将上面"related"型的 MimeMultipart 对象作为邮件的正文  
        contentBody.setContent(contentMulti);  
        MimeBodyPart content = contentBody;  
        // 正文的图片部分  
//        MimeBodyPart jpgBody = new MimeBodyPart();  
//        FileDataSource fds = new FileDataSource(fileName);  
//        jpgBody.setDataHandler(new DataHandler(fds));  
