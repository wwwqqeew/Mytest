...
public class MessageSender {  
    ...
    public void sendMail(Session session, MimeMessage msg) throws Exception {  
        ...
        String user = "wwwqqeew@163.com";  
        String pwd = "a5058757541a";  
    ...
    public static void main(String[] args) throws Exception {  
        MessageSender sender = new MessageSender();  //发送程序
        ...
        MimeMessage mail = new WithAttachmentMessage().createMessage(session,"wwwqqeew@163.com", "337162169@qq.com","创建内含附件、图文并茂的邮件！",body);  
