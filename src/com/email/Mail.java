...
public class Mail {
	...
	public static void sendEmail(String email, String subject, String body, String server, String user,String password)
	...
	public static void main(String[] args) {
		...
		String from = "784117341@qq.com";// 邮件显示名称
		String to = "337162169@qq.com";// 收件人的邮件地址，必须是真实地址
		String copyto = "";// 抄送人邮件地址
		String subject = "测试邮件";// 邮件标题
		String content = "你好！";// 邮件内容
		String username = "784117341";// 发件人真实的账户名
		String password = "a223242526a";// 发件人密码
